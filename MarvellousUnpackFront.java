...
public class MarvellousUnpackFront extends JLabel implements ActionListener
{
...
{
setDefaultCloseOpration(WindowConstants.DISPOSE_ON_CLOSE);
...
try
{
MarvellousUnpack obj = new MarvellousUnpack(text1, getText(), text2.getText() );
